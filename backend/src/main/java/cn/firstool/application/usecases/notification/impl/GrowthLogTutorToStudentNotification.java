...
public class GrowthLogTutorToStudentNotification extends NotificationFactory {

    public GrowthLogTutorToStudentNotification(NotificationDto data, Properties properties, UserCenterService userCenterService, ProgramCenterService programCenterService) {
